...
class UpdateBluprintWizard extends React.Component {
  constructor(props) {
    super(props)
    props.dispatch(setBreadcrumbs([
      { label: 'Update Bluprint' },
      { label: 'Configure' },
...
UpdateBluprintWizard.propTypes = propTypes

export default connect(mapStateToProps)(UpdateBluprintWizard)
